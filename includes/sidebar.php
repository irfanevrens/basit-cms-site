...
<div id="sidebar">
	...
	<a href="https://www.facebook.com/bahadir.kirlibal?fref=ts" target="_blank"><img src="images/facebook.png" alt="">  </a>
...
// icerikler sayfasına son eklenen 5  veriyi listeliyoruz
	$query = mysql_query("SELECT * FROM icerikler ORDER BY 1 DESC LIMIT 0,5");
