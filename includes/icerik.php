...
<!-- while içinde dizi indis adlarına atadığımız degişlenleri yazdırıyoruz -->
	<h2>
		<a href="sayfalar.php?id=<?php  echo $id; ?>"><!-- sayfalar php ye get ile başlığın id nosunu yolluyoruz -->
	...
	<p align="right" ><a href="sayfalar.php?id=<?php echo $id; ?>" style="font-size: 18px; color: blue; font-weight: bold;"> Devamını Oku </a> </p><!-- devamını oku kısmı -->
